        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              required
              pattern="\d{3}[-]\d{3}[-]\d{4}"
              title="Please enter a valid phone number (format: xxx-xxx-xxxx)"
            />
          </div>
          <div className="mb-4">
          ...
          <div className="mt-4 text-center">
            ...
            <div className="flex justify-center space-x-4 mt-2">
              <Image src="/google-icon.png" alt="Google" width={40} height={40} className="cursor-pointer" />
              <Image src="/facebook-icon.png" alt="Facebook" width={40} height={40} className="cursor-pointer" />
            </div>
          </div>
        </form>
      </div>
